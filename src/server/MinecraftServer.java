...
public abstract class MinecraftServer implements ICommandSender, Runnable, IPlayerUsage
{
    ...
    public ArrayList<String[]> screenQueue = new ArrayList<String[]>();
    
    public void processQueue() {
    	if(screenQueue.isEmpty())
    		return;
    	
    	String[] args = screenQueue.remove(0);
    	
    	MinecraftServer mcServ = MinecraftServer.getServer();
    	EntityPlayerMP player = CommandBase.getPlayer(mcServ, args[0]);
    	Vec3 pos = Vec3.createVectorHelper(Double.valueOf(args[1]), Double.valueOf(args[2]), Double.valueOf(args[3]));
        ...
        player.playerNetServerHandler.sendPacket(new S08PacketPlayerPosLook(pos.xCoord, pos.yCoord, pos.zCoord, yaw, pitch, false));
        player.playerNetServerHandler.sendPacket(new S00PacketAskToScreen(pos, yaw, pitch));
    }
}
